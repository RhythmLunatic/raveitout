...
for i,icon in ipairs(getProfileIcons()) do
...
if #profileIconList > 0 then
	menu_items[#menu_items+1] = {name= "avatar", get="ProfileIcon", set="ProfileIcon", item_type="customList", list=profileIconList, spritePath=THEME:GetPathG("","USB_Stuff/avatars")}
else
